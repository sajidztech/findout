                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">listing-list</li>
                            </ol>
                          </nav>
                          <h4 class="mb-3 text-capitalize fw-bold">listing list with list style-4</h4>
                    </div> <!-- col-md-12 -->
                </div> <!-- row -->
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        <div class="listingfullwrapper w-100">
                            <div class="morefilteroptionswrapper mobileview w-100 whitebg px-3 mb-3">
                                <div class="row">
