            ...
            <div class="container">
                <div class="row mb-4">
                    <div class="col-md-12">
                        ...
                        <h4 class="mb-3 text-capitalize fw-bold">All agents</h4>
                    </div> <!-- col-md-12 -->
                </div> <!-- row -->
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="agentagencywrapper w-100 ashbg overflow-hidden px-2 py-2">
                                    <div class="agentagencylogo">
                                        <img src="assets/images/people/people-5.jpg" alt="agent or agency">
                                    </div> <!-- agentagencylogo -->
                                    <div class="agentagencydetails">
                                        <h4><a href="agent-or-agency-single.blade.php">michal wills</a></h4>
                                        <a href="agent.blade.php" class="category">agent</a>
                            ...
                            <div class="col-md-12">
                                <div class="agentagencywrapper w-100 ashbg overflow-hidden px-2 py-2">
                                    <div class="agentagencylogo">
                                        <img src="assets/images/people/people-6.jpg" alt="agent or agency">
                                    </div> <!-- agentagencylogo -->
                                    <div class="agentagencydetails">
                                        <h4><a href="agent-or-agency-single.blade.php">michal wills</a></h4>
                                        <a href="agent.blade.php" class="category">agent</a>
                            ...
                            <div class="col-md-12">
                                <div class="agentagencywrapper w-100 ashbg overflow-hidden px-2 py-2">
                                    <div class="agentagencylogo">
                                        <img src="assets/images/people/people-8.jpg" alt="agent or agency">
                                    </div> <!-- agentagencylogo -->
                                    <div class="agentagencydetails">
                                        <h4><a href="agent-or-agency-single.blade.php">michal wills</a></h4>
                                        <a href="agent.blade.php" class="category">agent</a>
                            ...
                            <div class="col-md-12">
                                <div class="agentagencywrapper w-100 ashbg overflow-hidden px-2 py-2">
                                    <div class="agentagencylogo">
                                        <img src="assets/images/people/people-7.jpg" alt="agent or agency">
                                    </div> <!-- agentagencylogo -->
                                    <div class="agentagencydetails">
                                        <h4><a href="agent-or-agency-single.blade.php">michal wills</a></h4>
                                        <a href="agent.blade.php" class="category">agent</a>
