...
<?php require_once('../default-elements/admin-menu-contents.blade.php'); ?> 
            ...
            <div class="col-sm-12">
              ...
              <div class="createlistingfullsectionwrapper w-100 ashligthbg pt-50px pb-50px">
                  <div class="container">
                      <div class="row">
                          <div class="col-md-12">
                              <h2 class="fw-bolder text-capitalize">Waiting for your approval</h2>
                          </div> <!-- col-md-12 -->
                      </div> <!-- row -->
                      <form action="#" method="POST" class="row mt-3">
                          ...
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              ...
                              <input type="number" name="propertyaddlistingprice" id="propertyaddlistingprice" class="w-100" value="100">
                          </div> <!-- col-md-6 col-sm-12 -->
                              ...
                              <div class="row">
                                  <div class="col-md-6 col-sm-12">
                                    <div class="col-md-12 propertyaddlistingfileds">
                                        ...
                                        <input type="text" name="propertyaddlistingaddress" id="propertyaddlistingaddress" class="w-100" value="47/2 MG road">
                                    </div> <!-- col-md-12 -->
                                    <div class="col-md-12 propertyaddlistingfileds">
                                        <label for="propertyaddlistingstate">state/province/district</label>
                                        <input type="text" name="propertyaddlistingstate" id="propertyaddlistingstate" class="w-100" value="Dhaka">
                                    </div> <!-- col-md-12 -->
                                    <div class="col-md-12 propertyaddlistingfileds">
                                        <label for="propertyaddlistingcity">city</label>
                                        <input type="text" name="propertyaddlistingcity" id="propertyaddlistingcity" class="w-100" value="Narayanganj">
                                    </div> <!-- col-md-12 -->
                                    <div class="col-md-12 propertyaddlistingfileds">
                                        <label for="propertyaddlistingzipcode">zip</label>
                                        <input type="number" name="propertyaddlistingzipcode" id="propertyaddlistingzipcode" class="w-100"  value="1400">
                                    </div> <!-- col-md-12 -->
                                    <div class="col-md-12 propertyaddlistingfileds">
                                        <label for="propertyaddlistingcountry">country</label>
                                        <select class="js-example-basic-multiple w-100" id="propertyaddlistingcountry" name="propertyaddlistingcountry">
                                    ...
                                    <div class="col-md-12 propertyaddlistingfileds d-flex mt-3">
                                        <div class="row align-self-center">
                                            <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                                                ...
                                                <input type="number" name="propertyaddlistingmapslatitude" id="propertyaddlistingmapslatitude" class="w-100" value="40.123456789">
                                            </div> <!-- col-md-4 col-sm-12 -->
                                            <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                                                <label for="propertyaddlistinglongitude">Longitude</label>
                                                <input type="number" name="propertyaddlistinglongitude" id="propertyaddlistinglongitude" class="w-100" value="40.123456789">
                                            </div> <!-- col-md-4 col-sm-12 -->
                                            <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                                                <label for="propertyaddlistingzoom">zoom</label>
                                                <input type="number" name="propertyaddlistingzoom" id="propertyaddlistingzoom" class="w-100" value="14">
                                            </div> <!-- col-md-4 col-sm-12 -->
                                        </div> <!-- row -->
                                    </div> <!-- col-md-12 -->
                                  </div> <!-- col-md-6 col-sm-12 -->
                          ...
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              ...
                              <input type="text" name="propertyaddlistingid" id="propertyaddlistingid" class="w-100" value="3" disabled>
                          </div>  <!-- col-md-4 col-sm-12 -->
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingareasize">area size</label>
                              <input type="number" name="propertyaddlistingareasize" id="propertyaddlistingareasize" class="w-100" value="1400">
                          </div>  <!-- col-md-4 col-sm-12 -->
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingpostfix">area size postfix</label>
                              <input type="text" name="propertyaddlistingpostfix" id="propertyaddlistingpostfix" class="w-100" value="SQ.FT.">
                          </div>  <!-- col-md-4 col-sm-12 -->
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingbedrooms">bedroom(s)</label>
                              <input type="number" name="propertyaddlistingbedrooms" id="propertyaddlistingbedrooms" class="w-100" value="4">
                          </div>  <!-- col-md-4 col-sm-12 -->
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingpostbathrooms">bathroom(s)</label>
                              <input type="number" name="propertyaddlistingpostbathrooms" id="propertyaddlistingpostbathrooms" class="w-100" value="5">
                          </div>  <!-- col-md-4 col-sm-12 -->
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingpostkitchen">kitchen</label>
                              <input type="number" name="propertyaddlistingpostkitchen" id="propertyaddlistingpostkitchen" class="w-100" value="1">
                          </div>  <!-- col-md-4 col-sm-12 -->
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingpostgarage">garage</label>
                              <input type="number" name="propertyaddlistingpostgarage" id="propertyaddlistingpostgarage" class="w-100" value="1">
                          </div>  <!-- col-md-4 col-sm-12 -->
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingpostwarehouse">warehouse</label>
                              <input type="number" name="propertyaddlistingpostwarehouse" id="propertyaddlistingpostwarehouse" class="w-100" value="0">
                          </div>  <!-- col-md-4 col-sm-12 -->
                          <div class="col-md-4 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingpostguestroom">guestroom(s)</label>
                              <input type="number" name="propertyaddlistingpostguestroom" id="propertyaddlistingpostguestroom" class="w-100" value="1">
                          </div>  <!-- col-md-4 col-sm-12 -->
                          <div class="col-md-3 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingyearofbuild">year of build</label>
                              <input type="number" name="propertyaddlistingyearofbuild" id="propertyaddlistingyearofbuild" class="w-100" value="1997">
                          </div>  <!-- col-md-3 col-sm-12 -->
                          <div class="col-md-3 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingpostyearofrenovation">year of renovation</label>
                              <input type="number" name="propertyaddlistingpostyearofrenovation" id="propertyaddlistingpostyearofrenovation" class="w-100" value="2018">
                          </div>  <!-- col-md-3 col-sm-12 -->
                          <div class="col-md-3 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingpostvideourl">property video link</label>
                              <input type="url" name="propertyaddlistingpostvideourl" id="propertyaddlistingpostvideourl" class="w-100" value="https://www.yourpropertyvideourl.com">
                          </div>  <!-- col-md-3 col-sm-12 -->
                          ...
                          <div class="col-md-3 col-sm-12 propertyaddlistingfileds">
                              ...
                              <input type="number" name="propertyaddlistinglowestnumberofguest" id="propertyaddlistinglowestnumberofguest" class="w-100" value="1">
                          </div>  <!-- col-md-3 col-sm-12 -->
                          <div class="col-md-3 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistinghighestnumberofguest">highest guest can live</label>
                              <input type="number" name="propertyaddlistinghighestnumberofguest" id="propertyaddlistinghighestnumberofguest" class="w-100"  value="6">
                          </div>  <!-- col-md-3 col-sm-12 -->
                          <div class="col-md-3 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistinghighestbaby">highest Baby guest allow</label>
                              <input type="number" name="propertyaddlistinghighestbaby" id="propertyaddlistinghighestbaby" class="w-100" value="4">
                          </div>  <!-- col-md-3 col-sm-12 -->
                          <div class="col-md-3 col-sm-12 propertyaddlistingfileds">
                              <label for="propertyaddlistingdiscount">Discuount (If have) (%)</label>
                              <input type="number" name="propertyaddlistingdiscount" id="propertyaddlistingdiscount" class="w-100" placeholder="Type here only the number" value="15">
                          </div>  <!-- col-md-3 col-sm-12 -->
                          <div class="col-md-12 filedsgroupheading">
                          ...
                          <div class="row propertyaddlistingfileds">
                              <div class="col-md-12 radiobuttons mt-1">
                                <input type="checkbox" name="additionalfeaturebarbeque" id="additionalfeaturebarbeque" checked>
                                ...
                                <input type="checkbox" name="additionalfeaturelawan" id="additionalfeaturelawan" checked>
                                <label for="additionalfeaturelawan"><i class="fas fa-landmark"></i> lawan</label>
                                <input type="checkbox" name="additionalfeatureoutdoorshower" id="additionalfeatureoutdoorshower" checked>
                                <label for="additionalfeatureoutdoorshower"><i class="fas fa-shower"></i> outdoor shower</label>
                                <input type="checkbox" name="additionalfeaturemicrowave" id="additionalfeaturemicrowave" checked>
                                ...
                                <input type="checkbox" name="additionalfeaturewifi" id="additionalfeaturewifi" checked>
                                <label for="additionalfeaturewifi"><i class="fas fa-wifi"></i> wifi</label>
                                <input type="checkbox" name="additionalfeaturewasher" id="additionalfeaturewasher" checked>
                                ...
                                <input type="checkbox" name="additionalfeaturereastroom" id="additionalfeaturereastroom" checked>
                          ...
                          <div class="col-md-8 col-sm-8 col-xs-12 propertyaddlistingfileds mt-4">
                            <div class="radiobuttons w-100 overflow-hidden mt-1">
                                <input type="radio" name="propertyreviewstatus" id="propertyreviewstatusapproved">
                                <label for="propertyreviewstatusapproved">approved</label>
                                <input type="radio" name="propertyreviewstatus" id="propertyreviewstatusunderreview" checked>
                                <label for="propertyreviewstatusunderreview">under review</label>
                                <input type="radio" name="propertyreviewstatus" id="propertyreviewstatusrejected">
                                <label for="propertyreviewstatusrejected">reject</label>
                                <input type="radio" name="propertyreviewstatus" id="propertyreviewstatussoftrejected">
                                <label for="propertyreviewstatussoftrejected">soft reject</label>
                            </div> <!-- radiobuttons -->
                          </div> <!-- propertyaddlistingfileds -->
                          <div class="col-md-4 col-sm-4 col-xs-12 propertyaddlistingfileds mt-4">
                              <button type="submit" class="btn-2 w-100">Update</button>
                          </div> <!-- propertyaddlistingfileds -->
                      </form> <!-- row -->
                  </div> <!-- container -->
