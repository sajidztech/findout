<?php require_once('default-elements/public-header.blade.php'); ?> 
        <div class="listingfullwrapperherosection w-100">
            <div id="listingmapgoogle"></div>
        </div> <!-- listingfullwrapperherosection -->
        <div class="listinglistfullwrapper w-100 overflow-hidden ashligthbg pt-25px pb-75px">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">listing-with-map</li>
                            </ol>
                        </nav>
                        <h4 class="mb-3 text-capitalize fw-bold">list with map</h4>
                    </div> <!-- col-md-12 -->
                </div> <!-- row -->
                <div class="row">
                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto moreoption">
                                                <select name="statusofpost" id="statusofpost">
                                                    <option value=""  selected disabled hidden>proerty status</option>
